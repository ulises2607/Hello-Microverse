...
**[Hello Microverse]** is a simple project made with html and css. the purpose of the project is to test our abilities to use linters and github flow.
...
```sh
  cd my-folder
  git clone git@github.com:ulises2607/Hello-Microverse-Project.git
```
